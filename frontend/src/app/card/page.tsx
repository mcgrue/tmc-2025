...
import { getExactByName, getJank, getRandom } from "@/scryfall/scryfall";
...
async function roll(jankPrice: number) {
...
const { card, side2, partner, fetchTime } = await roll(JANK_PRICE);
